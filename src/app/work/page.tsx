...
export default function Work() {
  ...
  const [selectedProject, setSelectedProject] = useState<
    (typeof productDesignProjects)[0] | null
  >(null);
  ...
  const productDesignProjects = [
    {
      ...
      details: {
        ...
        belowCaption:
          "A product design case study on transforming a gated API gateway into a developer-first, self-serve experience.",
        overviewImage: "",
        ...
        designGoalTitle:
          "To improve usability and adoption, I set clear design goals:",
      ...
      overview: {
        ...
        backgroundText1:
          "RevUp, a product by Reverie Language Technologies, was built to provide APIs for language localization. However, access was restricted — developers had to request demos, wait for internal approvals, and communicate through sales channels just to begin testing.",
        backgroundText2:
          "I was tasked with transforming RevUp into a fully self-serve platform — enabling developers to register, try our APIs, access documentation, and generate API keys with minimal friction.",
        myRoleTitle: "My Role",
        myRoleText1:
          "As the sole product designer for RevUp, I owned the entire design process — from research and wireframing to UI design and developer handoff. I collaborated closely with the product and engineering teams to simplify a complex, sales-driven API platform into a seamless self-serve experience.",
        myRoleText2:
          "I created modular, scalable components, built a light pastel UI system using DM Sans, and ensured a consistent, developer-friendly experience across all touchpoints.",
      },
      problem: {
      ...
      learnings: {
        learningpt1:
          "Micro-interactions (copy, CTA states) matter deeply to devs",
        learningpt2: "Clear documentation access boosts trust and adoption",
        learningpt3:
          "Designing for self-service means anticipating user uncertainty",
      ...
      video: {
        ...
        videoText:
          "A walkthrough of the interactive prototype—showcasing how structure, flow, and micro-interactions come together to create a seamless developer experience.",
      },
    },
    {
      id: 2,
      ...
      solution:
        " Created a seamless writing experience supporting 11 languages.",
      ...
      overview: {
        ...
        backgroundTitle: "Background",
        backgroundText1:
          "Swalekh Pad is a multilingual text editor that empowers Indian language users to write, convert, and share content effortlessly across platforms. With built-in support for Unicode and TrueType fonts, it solves a long-standing problem in digital publishing: font incompatibility across Indian scripts.",
        backgroundText2: "",
        myRoleTitle: "My Role",
        myRoleText1:
      ...
      goals: {
        sectionTitle: "My Design Goals",
        title:
          "Swalekh Pad is a multilingual text editor that enables users to:",
      ...
      tldr: {
        tldrpt1:
          "I created Swalekh Pad to make multilingual typing intuitive, fast, and font-flexible.",
        tldrpt2:
          "  I created Swalekh Pad to make multilingual typing intuitive, fast, and font-flexible.Designed from the ground up, it empowers users to type in 11 Indian languages, switch between Unicode and TTF with a click, and export their content effortlessly — all within a clean, user-friendly interface.",
      },
      video: {
        video: "/swalekhvideo.mp4",
        videoText:
          "Watch how Swalekh Pad handles voice-to-text, font format switching, and multilingual translation in real time",
      },
    },
    {
      id: 3,
      ...
      title1: "",
      role: "Sole Product Designer",
      challenge: "Regional creators lacked tools to share voice content.",
      solution: "Built a creator-first interface with native language support.",
      image: "/shrotaimg.png",
      ...
      details: {
        ...
        belowCaption:
          "Translate, edit, and export subtitles effortlessly—across 11 Indian languages, all from a single intuitive interface.",
      },
      overview: {
        title: "Overview",
        webAppIcon: "/webapp.png",
        ...
        team: "1 PM, 3 Developers, QA, Me",
        focus:
          " Designing a clean, interface for subtitle editing, translation into 11 Indian languages, voice selection (per-line and global), and smooth export across formats.",
        backgroundTitle: "Background",
        backgroundText1:
          "With the explosion of video content across platforms, there was a rising need for tools that could make content accessible in India’s many languages.",
        backgroundText2:
          "Shrota was envisioned as a multilingual subtitling and translation tool — allowing users to upload videos, create subtitles, and translate them into 11+ Indian languages, all through a single, easy-to-use interface.",
        myRoleTitle: "My Role",
        myRoleText1:
          "As the sole Product Designer, I led the UX research and workflow mapping to identify user needs and define a streamlined experience. I designed the subtitle editing interface along with a timeline-based UI to enable precise control over text and timing.",
        myRoleText2:
          " My work included crafting intuitive interactions for translation and real-time preview, as well as developing a voice selection interface that supported both single and per-line voice options. Throughout the project, I built detailed prototypes to validate functionality and maintained close collaboration with developers to ensure a smooth and accurate design-to-development handoff.",
      },
      problem: {
        sectionTitle: "The Problem",
        title:
        ...
        problempt4:
          " Interfaces were cluttered or too technical for average creators",
      },
      goals: {
        sectionTitle: "My Design Goals",
        title:
          "Shrota simplifies multilingual subtitling through a clean, unified interface that allows users to:",

        goalpt1: "Auto-generate subtitles",
        goalpt2:
          "Manually edit subtitle text for accuracy or cultural relevance",
        goalpt3: "Translate subtitles into 11 Indian languages",
        goalpt4:
          "Select voice for the entire video or customize voice per line",
      },
      outcomes: {
      ...
      learnings: {
        learningpt1:
          "Designing for multilingual interfaces requires attention to both form and nuance",
        learningpt2:
          "A well-structured editor simplifies even complex translation workflows",
        learningpt3:
          "Inclusive UX is about empowering every voice — creators and audiences alike",
        learningpt4:
          "Simplicity doesn't mean fewer features; it means smarter visibility and timing",
      },
      whatsnext: {
        whatsnextpt1: " Add voice-to-text subtitle generation",
        whatsnextpt2: "Dark mode for long-form editors and late-night sessions",
        whatsnextpt3:
          "Add subtitle performance insights (views, languages watched)",
      },
      tldr: {
        tldrpt1:
          "I transformed Shrota from a concept into a full-featured, intuitive subtitling and translation platform. ",
        tldrpt2:
          " Designed to be both powerful and approachable, it now enables video creators to make content accessible across India’s diverse linguistic landscape — without technical barriers.",
      },
      video: {
        video: "/shrotavideo.mp4",
        videoText:
          "A guided video demo showcasing the full workflow — from uploading a video to editing subtitles, translating content, assigning voices, and exporting the final output.",
      },
    },
    {
      id: 4,
      ...
      role: "Sole Product Designer",
      challenge:
        "Reading digital content wasn’t accessible for all language users.",
      solution:
        "Designed a seamless listening experience for any content in 11 Indian languages.",
      image: "/vachakimg.png",
      ...
      details: {
        ...
        belowCaption:
          "Customize how you hear content across 11 Indian languages with voice, speed, and pitch settings.",
      },
      overview: {
        title: "Overview",
        webAppIcon: "/webapp.png",
      ...
      problem: {
        ...
        problempt4:
          "Minimal control over playback experience (voice, pitch, speed)",
      },
      goals: {
        sectionTitle: "My Design Goals",
        ...
        goalpt1:
          "Listen to articles, blog posts, or documents in 11 Indian languages",
      ...
      tldr: {
        tldrpt1:
          "This project taught me how critical small details—like the size of a speed slider or icon placement—are to making a tool feel personal, especially in a multilingual country. Designing for ears instead of eyes was a refreshing challenge!",
        tldrpt2: "  ",
      },
      video: {
  ...
  const graphicDesignData: Record<
    GraphicTabType,
    {
      title: string;
      subtitle: string;
  ...
  > = {
    social: {
      ...
      subtitle:
        "A collection of high-impact LinkedIn and campaign posts designed to communicate product value, drive engagement, and enhance brand recall through bold visuals and concise messaging.",
      images: ["/sm1.png", "/sm2.png", "/sm3.png", "/sm4.png"],
    },
    ebook: {
      title: "Ebook Design for Informative & Impactful Reading",
      subtitle:
        "Professionally designed ebooks combining structured content layouts, visual hierarchy, and illustrations to simplify complex topics—optimized for digital consumption across devices.",
      images: ["/ebook.png", "/ebook2.png"],
    },
    poster: {
      title: "Poster Designs for Communication & Awareness",
      subtitle:
        "Posters created for internal campaigns, product launches, and HR communications—designed to inform, engage, and inspire through strong visuals and messaging alignment.",
      images: ["/poster1.png", "/poster2.png", "/poster3.png", "/poster4.png"],
    },
    // animated: {
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-4 right-4 mt-2 bg-[#F9DBC1] rounded-2xl border border-[#C5A588] shadow-lg z-50 lg:hidden">
            <div className="py-4 px-6 space-y-2">
              {["home", "main", "digitalpainting", "about", "contact"].map(
                (view) => (
                  <button
                    key={view}
                    onClick={() => {
            ...
            <>
              ...
              <div className="relative">
                <div className="p-4 md:p-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">
                    {productDesignProjects[0].title1}
                  </h3>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-800">
                        {productDesignProjects[0].challenge}
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-800">
                        {productDesignProjects[0].solution}
                      </span>
                    </div>
                  </div>
              ...
              <div className="relative lg:mt-12 flex justify-center">
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">
                    {productDesignProjects[1].title1}
                  </h3>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-800">
                        {productDesignProjects[1].challenge}
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-800">
                        {productDesignProjects[1].solution}
                      </span>
                    </div>
                  </div>
              ...
              <div className="relative lg:mt-12">
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">
                    {productDesignProjects[2].title1}
                  </h3>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-800">
                        {productDesignProjects[2].challenge}
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-800">
                        {productDesignProjects[2].solution}
                      </span>
                    </div>
                  </div>
              ...
              <div className="relative lg:mt-12 flex justify-center">
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-4">
                    {productDesignProjects[3].title1}
                  </h3>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-800">
                        {productDesignProjects[3].challenge}
                      </span>
                    </div>
                    ...
                    <div>
                      ...
                      <span className="text-sm text-gray-800">
                        {productDesignProjects[3].solution}
                      </span>
                    </div>
                  </div>
          ...
          Animated Videos
              ...
              <div className="relative max-w-4xl mx-auto">
                <div className="relative overflow-hidden rounded-lg shadow-lg bg-gray-100">
                  ...
                  >
                    {graphicDesignData[graphicActiveTab].images.map(
                      (image, index) => (
                ...
                {graphicDesignData[graphicActiveTab].images.length > 1 && (
                  <div className="text-center mt-4">
                    <span className="text-sm text-gray-600">
                      ...
                      {graphicDesignData[graphicActiveTab].images.length}
                    </span>
                  </div>
                )}
              </div>
  ...
  const ProjectDetailView = ({
    ...
    project: (typeof productDesignProjects)[0];
  }) => (
    <div className="min-h-screen bg-[#FCFCFC] ">
      ...
      <div className="max-w-7xl mx-auto px-8 pb-16">
        ...
        <div
          id="designprocess"
          className="rounded-3xl py-12 relative overflow-hidden"
        >
        ...
        <div className="rounded-t-3xl py-12 relative overflow-hidden bg-[#FFF2E7]">
          <div className="flex justify-center">
            <Image
              width={600}
              height={600}
              src={project.designprocess.image}
              alt="Design Process"
        ...
        <div
          id="videosection"
          className="rounded-b-3xl pb-12 relative overflow-hidden bg-[#FFF2E7] "
        >
          <h1 className="text-2xl font-bold text-[#363444] text-center pb-1">
            Prototype Interaction{" "}
          </h1>
          <h2 className="text-lg  text-[#858394] text-center p-4 ml-10 mr-10">
            {project.video.videoText}
          </h2>
          <div className="flex justify-center">
            <video
            ...
            <div className="flex flex-col space-y-8 bg-[#F0FBFF] p-8 rounded-2xl h-full">
              ...
              <div className="space-y-4 flex-1">
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    {project.whatsnext.whatsnextpt1}
                  </p>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    {project.whatsnext.whatsnextpt2}
                  </p>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    {project.whatsnext.whatsnextpt3}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="rounded-3xl py-12 relative overflow-hidden bg-[#DBFFF1]">
          ...
          <div className="max-w-3xl mx-auto px-6 text-center space-y-4">
            ...
            <p className="text-base text-gray-700">{project.tldr.tldrpt2}</p>
          </div>
        </div>
      </div>
    </div>
