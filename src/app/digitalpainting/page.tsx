  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 mt-6 md:mt-8">
        <div className="text-center mb-4">
          <h1 className="text-xl md:text-2xl font-bold text-black">
            Digital Paintings from the Heart
          </h1>
        </div>
      </div>
      ...
      <div className="text-center mb-12">
        <h2 className="text-sm md:text-lg text-gray-800 mb-4 px-4 md:px-0">
          Each painting is a reflection of my emotions and thoughts, created to
          capture moments, tell silent stories, and express what words often
          cannot.
        </h2>
      </div>
