      ...
      <div className="min-h-screen bg-[url('/page1bg.png')]">
          ...
          <div className="bg-[#F9DBC1] rounded-full px-4 md:px-8 py-2 border border-[#C5A588] w-full max-w-screen-lg">
            <div className="flex items-center justify-between w-full">
              ...
              <div className="flex space-x-4 xl:space-x-8 hidden lg:flex">
                <Link
                  href="/"
                  className="text-gray-600 cursor-pointer hover:bg-white px-2 xl:px-4 py-2 rounded-full transition-all duration-300 transform hover:scale-105 inline-block text-sm xl:text-base"
                >
                  Home
                </Link>
                <Link
              ...
              <div className="flex space-x-4 xl:space-x-8 hidden lg:flex">
                <Link
                  href="/about"
                  className=" cursor-pointer bg-white text-gray-800 shadow-sm px-2 xl:px-4 py-2 rounded-full transition-all duration-300 transform hover:scale-105 inline-block text-sm xl:text-base"
                >
                  About
                </Link>
                <Link
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] md:min-h-[70vh] px-4 md:px-8 mt-8 md:mt-[3rem] text-center">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-700 mb-6 md:mb-8 max-w-2xl px-4">
            A designer with 10 years of experience in shaping thoughtful visuals
            and user-friendly journeys. From crafting brand stories to building
            intuitive products, my work blends structure with soul
          </p>

          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mb-8 md:mb-12 leading-relaxed px-4">
            I lead with curiosity, create with clarity, and always design with
            intent — whether it&apos;s a user flow, a poster, or a painting
          ...
          <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 px-4">
            <Link href="/work">
              <button className="w-full cursor-pointer sm:w-auto bg-orange-200 hover:bg-orange-300 text-gray-800 px-6 py-3 rounded-full font-medium transition-colors">
                View My Work
              </button>
            </Link>
            <Link href="/contact">
              <button className="w-full cursor-pointer sm:w-auto bg-white hover:bg-gray-50 text-gray-800 px-6 py-3 rounded-full font-medium border border-gray-200 transition-colors">
                Contact Me
              </button>
            </Link>
          </div>
        ...
        <div className="px-4 md:px-8 py-12 md:py-16 max-w-6xl mx-auto bg-[#FCFCFC]">
          ...
          <div className="text-center mb-8 md:mb-12 px-4">
            <p className="text-sm sm:text-base md:text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Over the last 10 years, I&apos;ve explored many dimensions of
              design—each one adding a new layer to my creative toolkit. These
              additional skills support and enrich my UX/UI work, helping me
              tell better stories and craft more holistic experiences.
            </p>
          </div>
              ...
              <div className="space-y-4 md:space-y-6">
                <div>
                  ...
                  <p className="text-gray-600 text-sm md:text-base">
                    – Crafting visual languages that reflect brand values
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm md:text-base">
                    – Building memorable brands from scratch
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm md:text-base">
                    – Adding personality and expression to interfaces and
                    campaigns
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm md:text-base">
                    – Creating subtle movements that guide, delight, and inform
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center">
            ...
            <div className="max-w-2xl mx-auto mb-6 md:mb-8 px-4">
              <p className="text-base md:text-lg text-gray-700 mb-4 md:mb-6">
                If you are building something meaningful — a product, a
                platform, or a story worth telling — I&apos;d love to be part of
                it.
              </p>
