      ...
      <div className="min-h-screen bg-[url('/page1bg.png')] ">
          ...
          <div className="bg-[#F9DBC1] rounded-full px-4 md:px-8 py-2 border border-[#C5A588] w-full max-w-screen-lg">
            <div className="flex items-center justify-between w-full">
              ...
              <div className="flex space-x-4 xl:space-x-8 hidden lg:flex">
                <Link
                  href="/"
                  className="bg-white text-gray-800 shadow-sm cursor-pointer px-2 xl:px-4 py-2 rounded-full transition-all duration-300 transform hover:scale-105 inline-block text-sm xl:text-base"
                >
                  Home
                </Link>
                <Link
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] md:min-h-[70vh] px-4 md:px-8 mt-8 md:mt-[4rem] text-center">
          ...
          <p className="text-sm sm:text-base text-gray-600 max-w-2xl mb-8 md:mb-12 leading-relaxed px-4">
            I craft digital experiences that blend logic with emotion — from
            scalable design systems to artistic expressions rooted in culture
            and calm.
          </p>
            ...
            <div className="relative">
              ...
              <div className="flex justify-center items-center space-x-4 md:space-x-8 lg:space-x-16 px-8 md:px-16 overflow-hidden">
                {visibleSlides.map((slide) => (
                  <div
                    key={slide.id}
                    className={`text-center relative ${slide.bgColor} p-2 md:p-4 rounded-xl shadow-md flex-shrink-0`}
                  >
                    <Image
                      src={slide.image}
                      alt={slide.alt}
                  ...
                  <div className="w-full lg:flex-1 lg:max-w-lg">
                    <div className="p-4 md:p-6">
                      ...
                      <div className="mb-4">
                        ...
                        <span className="text-sm text-gray-800">
                          Developers had to go through sales just to use the
                          API.
                        </span>
                      </div>
                      ...
                      <div className="mb-6">
                        ...
                        <span className="text-sm text-gray-800">
                          Designed a self-serve platform for instant API access.
                        </span>
                      </div>
        ...
        <div className="py-20 px-8 bg-[#FCFCFC]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-700 text-lg">
                It&apos;s my way of listening to what the heart feels when words
                fall short.
              </p>

              <p className="text-gray-700 text-lg mb-8">
                Art lets me stay curious, soft, and expressive — which shows up
                in how I approach human-centered design.
              </p>
